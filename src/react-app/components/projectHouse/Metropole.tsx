...
const PROJECT_TITLE = "Metropole";

const PROJECT_IMAGES = [
    "/images/project/metropole/1.png",
    "/images/project/metropole/2.png",
    "/images/project/metropole/3.png",
    "/images/project/metropole/4.png",
    "/images/project/metropole/5.png",
    "/images/project/metropole/6.png",
